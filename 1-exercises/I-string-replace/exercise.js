...
let new1= result.replace(10, 100000);
let new2 = new1.replace('dog', 'cat');
let new3 = new2.replace('great', 'brilliant');
let new4 = new3.replace('day', 'night');
console.log(new4.replace('day','night'));
